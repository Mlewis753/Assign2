...
/*
 * 
 * Objective:    This program uses the PayrollClassOneModify class
...
public class PayrollOneModifyApplication
{
    public static void main(String[] args) 
    {
        ...
        // Create an object of the PayrollClassOneModify Class
        // using the no-arg constructor
        PayrollClassOneModify payrollObjectOne = new PayrollClassOneModify();
        
        // Call the classes (object) method to calculate
        // and store the gross pay
        payrollObjectOne.calculateGrossPay();
        
        // Call the classes (object) method to calculate
        // and store the deductions
        payrollObjectOne.calculateDeductions();
        
        // Call the classes (object) method to calculate
        // and store the net pay
        payrollObjectOne.calculateNetPay();
        
        // Call the method to display the information to the user
        ...
        PayrollClassOneModify payrollObjectTwo = new 
                              PayrollClassOneModify(employeeNumber,
                                                    employeeName,
                                                    hoursWorked,
                                                    rateOfPay);
        ...
        // Call the classes (object) method to calculate
        // and store the gross pay
        payrollObjectTwo.calculateGrossPay();
        
        // Call the classes (object) method to calculate
        // and store the deductions
        payrollObjectTwo.calculateDeductions();
        
        // Call the classes (object) method to calculate
        // and store the net pay
        payrollObjectTwo.calculateNetPay();
    ...
    public static void displayDetailInformation(PayrollClassOneModify
                                                payrollObject)
    {
        // Format the output 
