 ...
 *               Class and creates two objects of the class
 *
 *
 *
 * Author:       Your Name
...
public class ExpectedTimeOneApplication
{
    public static void main (String[] args) 
    {
        ...
        // Create an object (or instance) of the ExpectedTimeClassOne using 
        // the no argument or default constructor
        ExpectedTimeClassOne expectedTimeObject1 = new ExpectedTimeClassOne();
        ...
        displayDetailInformation(expectedTimeObject1);
        ...
        // using the Constructor to pass the arguments to parameters
        // in the Constructor
        ExpectedTimeClassOne expectedTimeObject2 = new 
        ...
        // passing the object (argument) to the method
        // as well as calculate the expected time and display it  
        displayDetailInformation(expectedTimeObject2);
    }

    // Method to validate and obtain and return the project number
    ...
    // Method to validate and obtain and return the project name
    ...
    // Method to validate and obtain and return the optimistic time 
    ...
    // Method to validate and obtain and return the realistic time
    ...
    // Method to validate and obtain and return the pessimistic time
